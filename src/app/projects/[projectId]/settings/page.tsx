    ...
    <div className="min-h-screen bg-zinc-900 text-zinc-100 p-6 max-w-3xl mx-auto space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-zinc-500">
          These style settings serve as defaults for all products in this project. Products can override individual settings.
        </p>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          {dropdown('Default Aspect Ratio', 'default_aspect_ratio', ['16:9', '1:1', '9:16'])}
          {textInput('Default Fidelity', 'default_fidelity')}
          <div>
            <label className="block text-sm font-medium text-zinc-300 mb-1">Default Variations</label>
            <input
              type="number"
              min={1}
              max={50}
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-red-900/50 bg-red-950/20 p-4 flex items-center justify-between">
          <div>
            <p className="font-medium text-zinc-100">Delete this project</p>
            <p className="text-sm text-zinc-400">
              This action cannot be undone. All products, images, and settings will be permanently deleted.
            </p>
          </div>
          <button
            onClick={async () => {
